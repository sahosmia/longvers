        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Create Invoice</h1>
                    ...
                    <div className="text-right">
                        ...
                        <p className="text-sm font-bold text-neutral-700 dark:text-neutral-300 font-mono">{data.id}</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-neutral-900 dark:bg-neutral-100 rounded-2xl p-5 text-white dark:text-neutral-900">
                            ...
                            >
                                <Printer className="w-4 h-4 inline mr-2" /> {processing ? 'Saving...' : 'Save & Print'}
                            </button>
                        </div>
                    </div>
                </div>
