...
<head>
    ...
    <style>
        ...
        .details-grid { width: 100%; margin-bottom: 40px; border-top: 1px solid #eee; border-bottom: 1px solid #eee; padding: 20px 0; }
        .details-grid td { vertical-align: top; width: 50%; }
        .section-title { font-size: 10px; font-weight: bold; text-transform: uppercase; color: #999; margin-bottom: 10px; }
        .items-table { width: 100%; border-collapse: collapse; margin-bottom: 40px; }
        .items-table th { text-align: left; background: #f9fafb; color: #666; font-weight: 600; padding: 12px 8px; border-bottom: 1px solid #eee; }
        .items-table td { padding: 12px 8px; border-bottom: 1px solid #f3f4f6; }
        .text-right { text-align: right; }
        .text-center { text-align: center; }
        .summary-wrapper { text-align: right; }
        .summary-table { width: 250px; margin-left: auto; }
        .summary-table td { padding: 8px 0; }
        .total-row { font-size: 18px; font-weight: bold; color: #2563eb; border-top: 1px solid #eee; }
        .remarks { margin-top: 40px; font-style: italic; color: #666; font-size: 12px; }
